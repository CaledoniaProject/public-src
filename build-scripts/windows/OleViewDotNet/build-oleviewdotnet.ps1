...
$build_dir = $env:temp + "\oleviewdotnet-master"
$zip_path  = $env:temp + "\oleviewdotnet-master.zip"
...
$web.DownloadFile("https://github.com/tyranid/oleviewdotnet/archive/master.zip", $zip_path);
...
cmd /c c:\windows\nuget.exe restore OleViewDotNet.sln
...
Copy-Item "Release" -Destination "$out_dir\OleViewDotNet" -Recurse -force
